// Mock data for Name Strings clone - will be replaced with backend data later
...
export const navItems = [
  ...
  { name: "Men", href: "/collections/men", hasDropdown: false },
  { name: "Kids", href: "/collections/kids", hasDropdown: false },
  { name: "Express Shipping", href: "/collections/express", hasDropdown: false },
  { name: "Best sellers", href: "/collections/best-sellers", hasDropdown: false, highlight: true }
];
...
export const categoryShowcase = [
  ...
  },
  {
    ...
    link: "/products/signature-necklace"
  }
];
...
export const trustBadges = [
  {
    id: 1,
    title: "High Quality Metals",
    icon: "gem"
  },
  {
    id: 2,
    title: "Hand made per order",
    icon: "hand"
  },
  {
    id: 3,
    title: "Over 80k+ happy customers",
    icon: "users"
  },
  {
    id: 4,
    title: "Directly From us",
    icon: "package"
  }
];
...
export const testimonials = [
  {
    ...
    name: "Priya S.",
    rating: 5,
    comment: "Beautiful necklace! The personalization was perfect and my wife loved it.",
    product: "Chic Signature Necklace",
    date: "2024-01-15"
  },
  {
    id: 2,
    name: "Rahul M.",
    rating: 5,
    comment: "Great quality bracelet. Fast shipping and excellent packaging.",
    product: "Men Circle Bracelet",
    date: "2024-01-10"
  },
  {
    id: 3,
    name: "Anita K.",
    rating: 5,
    comment: "Perfect gift for my daughter. She wears it every day!",
    product: "Rainbow Kids Necklace",
    date: "2024-01-05"
  }
];